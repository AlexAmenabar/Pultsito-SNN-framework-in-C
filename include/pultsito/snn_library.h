...
struct synapse_t {
    ...
    int lr;
    void (*learning_rule)(synapse_t*, int); // pointer to learning rule function
...
struct spiking_nn_t{
    ...
    void (*neuron_re_initializer)(spiking_nn_t *, int, network_construction_lists_t*); // function pointers to initialize neurons
