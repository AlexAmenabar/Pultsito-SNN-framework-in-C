...
typedef struct {
    ...
    int t_last_pre_spike, t_last_post_spike; // times of last presynaptic neuron and postsynaptic neurons spikes
...
typedef struct{
    ...
    // general information
    int simulation_type, neuron_type, n_process, store, learn; // simulation type (clock, event), neuron type (LIF...), n_process (number of OpenMP processes), whether network will be stored, whether learning will be carried out
