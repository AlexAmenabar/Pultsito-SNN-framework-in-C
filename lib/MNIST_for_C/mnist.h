...
// set appropriate path for data // TODO: this is not ideal
#define TRAIN_IMAGE "./lib/MNIST_for_C/data/train-images.idx3-ubyte"
#define TRAIN_LABEL "./lib/MNIST_for_C/data/train-labels.idx1-ubyte"
#define TEST_IMAGE "./lib/MNIST_for_C/data/t10k-images.idx3-ubyte"
#define TEST_LABEL "./lib/MNIST_for_C/data/t10k-labels.idx1-ubyte"
...
void load_mnist()
{
    // alloc memory for dataset information
