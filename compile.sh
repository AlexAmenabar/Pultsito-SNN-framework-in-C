...
COMMANDS=(
    "gcc -Wall -Iinclude -Iinclude/pultsito -Ilib -o bin/main_parallel_inference_simulation src/pultsito/main.c src/pultsito/snn_library.c src/pultsito/load_data.c src/pultsito/helpers.c src/pultsito/neuron_models/lif_neuron.c src/pultsito/training_rules/stdp.c src/pultsito/simulations/simulations.c -lm -DOPENMP -DNO_LEARN -fopenmp"
    "gcc -Wall -Iinclude -Iinclude/pultsito -Ilib -o bin/main_parallel_inference_simulation_reorder src/pultsito/main.c src/pultsito/snn_library.c src/pultsito/load_data.c src/pultsito/helpers.c src/pultsito/neuron_models/lif_neuron.c src/pultsito/training_rules/stdp.c src/pultsito/simulations/simulations.c -lm -DOPENMP -DREORDER -DNO_LEARN -fopenmp"
    "gcc -Wall -Iinclude -Iinclude/pultsito -Ilib -o bin/main_inference_simulation src/pultsito/main.c src/pultsito/snn_library.c src/pultsito/load_data.c src/pultsito/helpers.c src/pultsito/neuron_models/lif_neuron.c src/pultsito/training_rules/stdp.c src/pultsito/simulations/simulations.c -lm -DNO_LEARN -DOPENMP"
    "gcc -Wall -Iinclude -Iinclude/pultsito -Ilib -o bin/main_inference_simulation_reorder src/pultsito/main.c src/pultsito/snn_library.c src/pultsito/load_data.c src/pultsito/helpers.c src/pultsito/neuron_models/lif_neuron.c src/pultsito/training_rules/stdp.c src/pultsito/simulations/simulations.c -lm -DREORDER -DNO_LEARN -DOPENMP"
    "gcc -Wall -Iinclude -Iinclude/pultsito -Ilib -g -O0 -o bin/main_parallel_inference_simulation_reorder_g src/pultsito/main.c src/pultsito/snn_library.c src/pultsito/load_data.c src/pultsito/helpers.c src/pultsito/neuron_models/lif_neuron.c src/pultsito/training_rules/stdp.c src/pultsito/simulations/simulations.c -lm -DREORDER -DNO_LEARN -DOPENMP"
    "gcc -Wall -Iinclude -Iinclude/pultsito -Ilib -g -O0 -o bin/main_parallel_inference_simulation_g src/pultsito/main.c src/pultsito/snn_library.c src/pultsito/load_data.c src/pultsito/helpers.c src/pultsito/neuron_models/lif_neuron.c src/pultsito/training_rules/stdp.c src/pultsito/simulations/simulations.c -lm -DNO_LEARN -DOPENMP"
)
